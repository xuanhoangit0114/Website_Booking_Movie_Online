...
<body>
	...
	<div class="screen-container">
		...
		<br>
		<p>
			<b>Quý khách chú ý : <font color="yellow">[CHÚ Ý] <br>
					</br> Màu đỏ là ghế đã được đặt
			</font>
		...
		<div class="container">
			<form action="infor_seat" method="post" name="seats" onsubmit="return validateform()">>
...
var check = document.seats.check_seat.status.value;
if (check==1) {
