                ...
                <div class="product-desc">
                   ...
                   ${ticket.price } VND
                    ...
                    <div class="m-t text-righ">
                        <a href="cancelticket?ticket_id=${ticket.id}" 
                        onclick="sucsess()"
                         class="btn btn-xs btn-outline btn-danger">Huỷ Vé 
...
<jsp:include page="footer.jsp" />
 <script>
 function sucsess(){  
	 var result = confirm("Bạn có muốn huỷ vé không ?");
	 if (result == false) {
		window.location="http://localhost:8080/Website_Booking_Movie_Online/bill";
		}
	  }  
 </script>
</body>
